    ...
    <body>
        ...
        <div class="content user_forms">
            <div id="contact" class="inner">
                <h1><?php _e('Contact seller', 'katrina'); ?></h1>
                <ul id="error_list"></ul>
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="post" name="contact_form" id="contact_form">
                    <fieldset>
                        ...
                        <label><?php _e('To (seller)', 'katrina'); ?>: <?php echo osc_item_contact_name();?></label><br />
                        ...
                        <?php } else { ?>
                            <label for="yourName"><?php _e('Your name', 'katrina'); ?></label> <?php ContactForm::your_name(); ?><br />
                            <label for="yourEmail"><?php _e('Your e-mail address', 'katrina'); ?></label> <?php ContactForm::your_email(); ?><br />
                        <?php }; ?>
                        <label for="phoneNumber"><?php _e('Phone number', 'katrina'); ?> (<?php _e('optional', 'katrina'); ?>)</label> <?php ContactForm::your_phone_number(); ?><br />
                        <label for="message"><?php _e('Message', 'katrina'); ?></label> <?php ContactForm::your_message(); ?><br />
                        <?php osc_show_recaptcha(); ?>
                        <button type="submit"><?php _e('Send message', 'katrina'); ?></button>
                    </fieldset>
                </form>
            </div>
        </div>
