        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('form#change-username').validate({
                    ...
                    messages: {
                        s_username: {
                            required: '<?php echo osc_esc_js(__('Username: this field is required', 'katrina')); ?>.'
                        }
                    },
                        ...
                        cInterval = setInterval(function(){
                            $.getJSON(
                                ...
                                function(data){
                                    clearInterval(cInterval);
                                    if(data.exists==0) {
                                        $("#available").text('<?php echo osc_esc_js(__('The username is available', 'katrina')); ?>');
                                    } else {
                                        $("#available").text('<?php echo osc_esc_js(__('The username is NOT available', 'katrina')); ?>');
                                    }
                                }
                            );
                        }, 1000);
    ...
    <body>
        ...
        <div class="content user_account">
            ...
            <div id="main" class="modify_profile">
                <h2><?php _e('Change your username', 'katrina'); ?></h2>
                <ul id="error_list"></ul>
                <form id="change-username" action="<?php echo osc_base_url(true); ?>" method="post">
                    ...
                    <fieldset>
                        <p>
                            <label for="s_username"><?php _e('Username', 'katrina'); ?></label>
                            <input type="text" name="s_username" id="s_username" value="" />
                        </p>
                        <p>
                            <span class="help-box" ><?php _e('WARNING: Once set, you will not be able to change your username again. Choose wisely.', 'katrina'); ?></span>
                        </p>
